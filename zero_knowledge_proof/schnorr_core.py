...
from zero_knowledge_proof.data import ZKParameters, ZKSignature, ZKProof, ZKData, dump
from zero_knowledge_proof.utils.convert import (
    to_bytes, to_str, bytes_to_int, int_to_bytes, b64e, b64d,
)
from zero_knowledge_proof.utils.crypto import curve_by_name, hash_numeric, hash_data, mod
...
class ZK:
    ...
    def _to_point(self, value: Union[int, bytes, ZKSignature]):
        ...
        # don't know why this is here, it was uncommented before and was not working
        # point.recover()
        return point
